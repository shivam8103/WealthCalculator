    ...
    public partial class Form4 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
                ...
                int.TryParse(textBox3.Text, out int loanTermInYears))
            {
                ...
                double emi = loanAmount * monthlyInterestRate * Math.Pow(1 + monthlyInterestRate, loanTermInMonths) /
                ...
                textBox4.Text = "₹ " + loanAmount.ToString("N0", CultureInfo.CreateSpecificCulture("hi-IN")); // Principal amount
                textBox5.Text = "₹ " + emi.ToString("N0", CultureInfo.CreateSpecificCulture("hi-IN")); // Monthly repayment
                textBox6.Text = "₹ " + totalRepayment.ToString("N0", CultureInfo.CreateSpecificCulture("hi-IN")); // Total repayment
                textBox7.Text = "₹ " + interestPaid.ToString("N0", CultureInfo.CreateSpecificCulture("hi-IN")); // Interest paid
            }
            else
            {
